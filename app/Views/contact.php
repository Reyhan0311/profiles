               ...
               <section class="s-pagecontent pagecontent">
                    ...
                    <div class="row pageintro">
                        <div class="column xl-6 lg-12">
                            <h2 class="text-display-title">kata kata inspiratif</h2>
                        </div>
                        <div class="column xl-6 lg-12 u-flexitem-x-right">
                            <p class="lead">
                            saya masih berkuliah di universitas muhammadiyah Sukabumi. saya masih belajar dan terus belajar. saya ingin menjadi seorang web developer yang handal dan profesional
                            </p>
                        </div>                       
                    </div> <!-- pageintro -->   
                        ...
                        <div class="column xl-12">
                            ...
                            <div class="row">
                                <div class="column xl-6 md-12 contact-cta">     
                                    <p>
                                    Jika Anda memiliki pertanyaan lebih lanjut atau memerlukan informasi tambahan, Anda dapat menghubungi saya langsung. Informasi kontak saya tercantum di bawah ini untuk memudahkan Anda dalam menghubungi saya. Saya tersedia melalui nomor telepon dan alamat email yang disediakan, dan saya akan berusaha untuk merespons pertanyaan atau permintaan Anda secepat mungkin. Terima kasih atas perhatian dan kerjasamanya.
                                    </p>
        
                                    <a href="mailto:reyhankhidir256@gmail.com" class="btn btn--primary u-fullwidth contact-btn">
                                ...
                                <div class="column xl-5 md-12 u-flexitem-x-right">
                                    ...
                                    <div class="contact-block">
                                        <h6>Email</h6>
                                        <a href="mailto:reyhankhidir256@gmail.com">reyhankhidir256@gmail.com</a>
                                    </div>

                                    <div class="contact-block">
                                        <h6>Phone</h6>
                                        <ul class="contact-list">
                                            <li><a href="tel:+62 858-4649-3948">+62 858 4649 3948</a></li>
                                            <li><a href="tel:0858-4649-3948">0858 4649 3948</a></li>
                                            <li><a href="tel:085846493948">085846493948</a></li>
                                        </ul>
                                    </div>
