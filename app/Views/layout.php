            ...
            <div class="row s-header__inner width-sixteen-col">
                ...
                <div class="s-header__block">
                    <div class="s-header__logo">
                        <a class="logo" href="#">
                            <img src="images/Reyhan.png" alt="Homepage">
                        </a>
                    </div>
                ...
                <nav class="s-header__nav">
                    ...
                    <div class="s-header__contact">
                        <a href="/contact" class="btn btn--primary s-header__contact-btn">Hubungi saya</a>                        
            ...
            <div class="row row-x-center text-center">
                <div class="column xl-8 lg-12">
                    ...
                    <div class="s-cta__content">
                        ...
                        Jika ingin ada yang di tanyakan
                        </h2>
                        <p class="lead">
                        Untuk informasi mendetail, Anda bisa menghubungi saya melalui email atau nomor telepon yang tertera dibawah ini.
                        </p>
                        <a href="/contact" class="btn btn--primary">silahkan hubungi saya</a>
                    </div>
